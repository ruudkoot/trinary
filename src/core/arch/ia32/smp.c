...
void smp_arch_parsempct(smp_arch_mpct* mpct)
{
    ...
    for (i = mpct->entrycount; i > 0; i--)
    {
        switch (mpct->configuration[n])
        {
            ...
            case 0:
            {
                processor = ((smp_arch_processor*)(mpct->configuration + n));
                n += 20;
            ...
            case 1:
            {
                bus = ((smp_arch_bus*)(mpct->configuration + n));
                n += 8;
            ...
            case 2:
            {
                ioapic = ((smp_arch_ioapic*)(mpct->configuration + n));
                n += 8;
            ...
            case 3:
            {
                iointerrupt = ((smp_arch_iointerrupt*)(mpct->configuration + n));
                n += 8;
            ...
            case 4:
            {
                localinterrupt = ((smp_arch_localinterrupt*)(mpct->configuration + n));
                n += 8;
